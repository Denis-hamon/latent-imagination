#!/usr/bin/env python3
"""Story coverage-ts-v4 — labellisation stricte DISTANTE (node --test sur worldmonitor).
...
Q = ROOT / "data" / "landing" / "act2-pilot" / "coverage-ts-4"
...
def main() -> int:
    ...
    print(f"\n== TSv4-L : {done} déjà mesurés, {run} exécutés, {errors} erreurs ==")
    return 0
