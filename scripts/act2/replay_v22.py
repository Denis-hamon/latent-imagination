#!/usr/bin/env python3
"""Fenêtre v22 (812f6ad4) — replay mitige DW-52 sur tickets vérifiés à petits fichiers.
...
OUT = NH / "replay-v22"
ROWS = NH / "replay-rows-v22.jsonl"
COUNTER = NH / "call-counter-v22.jsonl"
SELECTION = OUT / "replay-selection-v22.json"
CAP_TOTAL = 480
CAP_MODEL = 120
MAX_TURNS = 4
FEEDBACK_CHARS = 800
...
def select_tickets() -> list[dict]:
    ...
    SELECTION.write_text(json.dumps({"window": "v22", "anchor": "812f6ad478095263",
