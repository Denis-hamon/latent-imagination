#!/usr/bin/env python3
"""Window coverage-ts-v4 — staging : quota-tasks validés → répertoire campagne
coverage-ts-4 (staging-extract.json + buggy sources) pour le harness budget.
...
SRC = ROOT / "data" / "landing" / "act2-pilot" / "ts-v4"
OUT = ROOT / "data" / "landing" / "act2-pilot" / "coverage-ts-4"
...
def main() -> int:
    ...
    blob = json.dumps({"window": "coverage-ts-v4",
