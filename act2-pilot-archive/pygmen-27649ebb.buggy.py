...
class HtmlFormatter(Formatter):
    ...
    **Subclassing the HTML formatter**
    ...
    def get_background_style_defs(self, arg=None):
        """Return CSS style definitions for the background of the code blocks."""
        ...
        if self.style.background_color is not None:
            style.append(f'{prefix("code")} {{ background: {self.style.background_color} }}')
            style.append(f'{prefix("pre")} {{ background: {self.style.background_color} }}')
    
        if self.style.highlight_color is not None:
            style.append(f'{prefix("hll")} {{ background: {self.style.highlight_color} }}')
